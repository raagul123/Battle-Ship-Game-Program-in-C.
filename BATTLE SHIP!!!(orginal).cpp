...
{
	srand(time(0));
	int li,lj,seatype,inventory[10],i,j,flag=0,count=0,f=0,f1=0,f2=0,f3=0,f4=0,pt,x,seaplay[10][10]={0},fh,jc,ic,fw=0,inventoryc[10],seaplayc[10][10]={0},ptc,sumh=0,sumc=0,k,l,flagc=0;
					...
					u1:	printf("Placement of ship %d\n",i+1);
                    	...
                    	switch(pt)
                    	{
                        	case 1:	flag=0;
									if(inventory[i]==1)
                               	 	{
                                    l3:	printf("Enter the starting row of the ship(1 to 5):");
                                    	scanf("%c%*c",&sp);
										...
										{
											l4:	printf("Enter the starting row and column of the ship\n");
												scanf("%c%c",&sp,&sc);
												scanf("%*c");
												sc=toupper(sc);
										if(sp=='1'||sp=='2'||sp=='3'||sp=='4'||sp=='5')
									...
									{
									l5:	printf("Enter the starting row and column of the ship\n");
										scanf("%c%c",&sp,&sc);
										scanf("%*c");
										sc=toupper(sc);
										if(sp=='1'||sp=='2'||sp=='3'||sp=='4'||sp=='5')
									...
									{
									l6:	printf("Enter the starting row and column of the ship\n");
										scanf("%c%c",&sp,&sc);
										scanf("%*c");
										sc=toupper(sc);
										if(sp=='1'||sp=='2'||sp=='3'||sp=='4'||sp=='5')
								...
								case 2:if(inventory[i]==1)
                               	 		{
											c1:	printf("Enter the starting column of the ship(A to E):");
                                    		scanf("%c%*c",&sc);
                                    		sc=toupper(sc);
									...
									{
									c2:	printf("Enter the starting column and row of the ship\n");
										scanf("%c%c",&sc,&sp);
										scanf("%*c");
										sc=toupper(sc);
										if(sc=='A'||sc=='B'||sc=='C'||sc=='D'||sc=='E')
									...
									{
									c3:	printf("Enter the starting column and row of the ship\n");
										scanf("%c%c",&sc,&sp);
										scanf("%*c");
										sc=toupper(sc);
										if(sc=='A'||sc=='B'||sc=='C'||sc=='D'||sc=='E')
									...
									{
									c4:	printf("Enter the starting column and row of the ship\n");
										scanf("%c%c",&sc,&sp);
										scanf("%*c");
										sc=toupper(sc);
										if(sc=='A'||sc=='B'||sc=='C'||sc=='D'||sc=='E')
